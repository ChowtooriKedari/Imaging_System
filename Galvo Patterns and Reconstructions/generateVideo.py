...
file_paths = [f'matched_waveform_{i}.csv' for i in range(1, 301)]

# Load data into a list of DataFrames
data_frames = [pd.read_csv(file) for file in file_paths]

# Determine number of timestamps (rows)
num_rows = len(data_frames[0])

# Get global voltage range across all files
...
# 3x3 grid detector positions (row, col)
grid_size = (3, 100)
...
video_filename = "1K_500mV_500us/1K_500mV_500us.mp4"
ani.save(video_filename, writer='ffmpeg', fps=1000)  # Save as .mp4 video with 30 fps
